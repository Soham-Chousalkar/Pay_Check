...
export const RetroDigitalNumber = memo(({ value, className = "", showDollarSign = false }) => {
  ...
  return (
    <div className={`retro-digital ${className}`}>
      {showDollarSign && (
        <img
          src="/assets/icons/Dollar-sign.png"
          alt="$"
...
// Main RetroDigital component that combines both
export const RetroDigital = () => {
  return (
    <div className="retro-digital-container">
      <RetroDigitalText text="PAY CHECK" className="text-2xl mb-4" />
      <RetroDigitalNumber value="0.00" showDollarSign={true} className="text-4xl" />
    </div>
  );
};
