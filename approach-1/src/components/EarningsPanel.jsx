...
function EarningsPanel({ panelTitleDefault = "PayTracker", useRetroStyleGlobal = true, onStateChange, panelOpacity = 60 }) {
  ...
  // Single effect to handle state changes with debouncing
  useEffect(() => {
    const updateState = () => {
    ...
    const timeoutId = setTimeout(updateState, 100); // Increased debounce time
          ...
          <div className="px-5 mb-2">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-center gap-3 mt-1">
                <button className="control-button flex items-center justify-center" onClick={saveTimeEditor} title="Save">
                ...
                <button className="control-button flex items-center justify-center" onClick={cancelTimeEditor} title="Cancel">
